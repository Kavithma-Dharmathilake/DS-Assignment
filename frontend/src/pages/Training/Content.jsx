            ...
            <div id="content-wrapper" className="d-flex flex-column" style={{ marginTop: "8rem" }}>
                <>
                    ...
                    {/* DataTales Example */}
                        ...
                        <a onClick={addnewcontent} className="btn btn-primary btn-icon-split m-3" style={{ width: "11rem", padding: "0" }}>
                            <span onClick={addnewcontent} className="icon text-white-50">
                                <i className="fa fa-plus" />
                            </span>

                            <span onClick={addnewcontent} className="text" style={{ color: "white" }}>Add New Content</span>
                        </a>
                    ...
                    <Link to="/addquiz">
                        ...
                        <a onClick={addnewcontent} className="btn btn-primary btn-icon-split m-3" style={{ width: "11rem", padding: "0" }}>
                            ...
                            <span onClick={addnewcontent} className="text" style={{ color: "white" }}>Add New Quiz</span>
                        </a>
                    </Link>

                    <div className="card shadow mb-4">
                        <div className="card-header py-3">
                            <h6 className="m-0 font-weight-bold text-primary">Your Contents</h6><br />
